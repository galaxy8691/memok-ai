...
**OpenClaw plugin (separate repo):** [galaxy8691/memok-ai-openclaw](https://github.com/galaxy8691/memok-ai-openclaw) — installs this package as `memok-ai-core` and loads only the thin gateway extension.
